                           ...
                           <tr>
                              ...
                              <td>
                                 <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#edit<?=$idmasuk;?>">Edit</button>
                                 <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#delete<?=$idmasuk;?>">Hapus</button>
                              </td>
                           </tr>
                                    ...
                                    <form method="POST">
                                       ...
                                       <div class="modal-body">
                                          ...
                                          <input type="number" name="qty" class="form-control mt-2"
                                             placeholder="Jumlah Produk" required value="<?=$qty;?>">
                                       ...
                                       <div class="modal-footer">
                                          <button type="submit" class="btn btn-success"
                                             name="editbarangmasuk">Update</button>
