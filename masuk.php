    ...
    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?=$idmasuk;?>">Hapus</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <input type="text" name="namaproduk" class="form-control" placeholder="Nama Produk" disabled value="<?=$namaproduk;?> : <?=$deskripsi;?>">
                                                    <input type="number" name="qty" class="form-control mt-2" placeholder="Jumlah Produk" required value="<?=$qty;?>">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="editbarangmasuk">Update</button>
