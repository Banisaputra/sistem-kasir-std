                           ...
                           <tr>
                              ...
                              <td>
                                 <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#edit<?=$idproduk;?>">Edit</button>
                                 <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#delete<?= $idproduk; ?>">Hapus</button>
                              </td>
                           </tr>
                           <!-- The Modal edit -->
                                    ...
                                    <form method="POST">
                                       ...
                                       <div class="modal-body">
                                          <input type="text" name="namaproduk" class="form-control"
                                             placeholder="Nama Produk" required value="<?= $namaproduk; ?>">
                                          <input type="text" name="deskripsi" class="form-control mt-2"
                                             placeholder="Deskripsi" required value="<?= $deskripsi; ?>">
                                          <input type="num" name="harga" class="form-control mt-2"
                                             placeholder="Harga Produk" required value="<?= $harga; ?>">
      ...
      <div class="modal-content">
         ...
         <form method="POST">
            ...
            <div class="modal-body">
               ...
               <input type="number" name="hargabeli" class="form-control mt-2" placeholder="Harga Beli" min="1"
                  required>
               <input type="number" name="hargajual" class="form-control mt-2" placeholder="Harga Jual" min="1"
                  required>
            </div>
