                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumlah Pelanggan : <strong><?= $h2; ?></strong></div>
                                </div>
                            </div>
                        </div>
                        <!-- button modal open -->
    ...
    ?>
                                        <tr>
                                           ...
                                           <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $idpl; ?>">Hapus</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" name="notelp" class="form-control mt-2" placeholder="No. Telp" required value="<?= $notelp; ?>">
                                                    <input type="num" name="alamat" class="form-control mt-2" placeholder="Alamat" required value="<?= $alamat; ?>">
                                                    <input type="hidden" name="idpl" value="<?= $idpl; ?>">
                                                    </div>

                                                    <!-- Modal footer -->
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="editpelanggan">Update</button>
