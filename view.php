            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h3 class="mt-3">Nama Pelanggan : <?=$namapel;?></h3>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="number" name="qty" class="form-control mt-2" placeholder="Jumlah Produk" min="1" required value="<?=$qty;?>">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-success" name="editpesanan">Update</button>
