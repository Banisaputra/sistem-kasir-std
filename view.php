      ...
      <div id="layoutSidenav_content">
         <main>
            <div class="container-fluid px-4">
               ...
               <button type="button" class="btn btn-primary mb-4 ms-5" data-bs-toggle="modal"
                  data-bs-target="#cetak<?=$idp;?>">
                  Cetak Nota
               </button>
                           ...
                           <tr>
                              ...
                              <td>
                                 <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#edit<?=$idpr;?>">Edit</button>
                                 <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#delete<?=$idpr;?>">Hapus</button>
                              </td>
                           </tr>
                                    ...
                                    <form method="POST">
                                       ...
                                       <div class="modal-body">
                                          <input type="text" name="namaproduk" class="form-control"
                                             ...
                                             value="<?=$namaproduk;?> : <?=$deskripsi;?>">
                                          <input type="number" name="qty" class="form-control mt-2"
                                             placeholder="Jumlah Produk" min="1" required value="<?=$qty;?>">
                                       ...
                                       <div class="modal-footer">
                                          <button type="submit" class="btn btn-success"
                                             name="editpesanan">Update</button>
